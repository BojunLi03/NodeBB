...
interface ModsController {
  flags: {
    ...
    detail: (req: any, res: any, next: any) => Promise<void>;
    postQueue: (req: any, res: any, next: any) => Promise<void>;
  };
}
...
modsController.flags.postQueue = async function (req, res, next): Promise<void> {
    ...
    res.render('post-queue', {
        ...
        posts: postData,
        isAdmin: isAdmin,
        canAccept: (isAdmin || isGlobalMod || !!moderatedCids.length) as boolean,
        ...categoriesData,
        // The next line calls a function in a module that has not been updated to TS yet
